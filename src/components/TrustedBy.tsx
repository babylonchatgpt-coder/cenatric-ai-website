      ...
      <div className="container mx-auto max-w-6xl px-6">
        <div className="text-center mb-12">
          ...
          <div className="relative">
            <div className="flex animate-scroll-left hover:[animation-play-state:paused] gap-12 md:gap-16">
              {duplicatedCompanies.map((company, index) => (
                <div 
                  key={index}
                  className="group flex items-center gap-3 flex-shrink-0 transition-all duration-300"
                >
                  ...
                  <span className="text-xl font-bold text-muted-foreground/70 group-hover:text-primary transition-colors whitespace-nowrap">
                    {company}
                  </span>
                </div>
              ))}
