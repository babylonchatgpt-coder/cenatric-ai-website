      ...
      <div className="container mx-auto max-w-4xl px-6">
        ...
        <div className="bg-accent p-8 md:p-12 rounded-2xl mb-12">
          <p className="text-lg md:text-xl leading-relaxed text-accent-foreground">
            <strong className="text-primary">Lunara stands for more than just a chatbot.</strong> We take businesses a step further in the digital age. 
          ...
          <p className="text-lg md:text-xl leading-relaxed text-accent-foreground mt-6">
            ...
            while Lunara takes away the repetitive work. This means more efficiency, fewer missed opportunities, and better customer experience.
          </p>
        </div>
